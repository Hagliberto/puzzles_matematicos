...
createDragDropGame({gameId:"triangulo-soma-10",slotCount:6,numbers:[1, 2, 3, 4, 5, 6],lines,solution:[1, 4, 6, 5, 2, 3],nextUrl:"../triangulo-soma-11/",nextLabel:"Ir para o próximo",hints:["Os cantos participam de duas somas. Eu começaria por eles!","Quando um lado fechar, tente não mexer nele.","As casas do meio ajustam uma soma por vez.","Se travar, troque dois cantos e veja como as somas mudam."]});
