...
createDragDropGame({gameId:"triangulo-soma-09",slotCount:6,numbers:[1, 2, 3, 4, 5, 6],lines,solution:[1, 5, 6, 3, 4, 2],nextUrl:"../triangulo-soma-10/",nextLabel:"Ir para o próximo",hints:["Os cantos participam de duas somas. Eu começaria por eles!","Quando um lado fechar, tente não mexer nele.","As casas do meio ajustam uma soma por vez.","Se travar, troque dois cantos e veja como as somas mudam."]});
